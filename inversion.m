...
The output will be another filename, this one linking to the results from
the data inversion.
%}
...
options.samplePrior = false; %If true, will always accept sln (only use this for testing)
options.pctSteps = 3;
