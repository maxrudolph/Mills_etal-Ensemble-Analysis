...
for i = 1:numEnsembles
    ...
    for j=1:length(allClusterSets)
        ...
        for k=2:length(allClusterSets{j})
            if j==3
                allClusterSets{j}{k}.displayName = ['k-Medoids Euclidean ' allClusterSets{j}{k}.displayName];
            elseif j==4
                allClusterSets{j}{k}.displayName = ['k-Medoids Manhattan ' allClusterSets{j}{k}.displayName];
            end
