...
filename = 'Ensemble_Constable1984_Wauchope__hierarchical-1_rhoPrior-2_1_PRIOR_18-Nov-2023.mat';
load(filename)
...
mask = ~isnan(thicknesses);
figure, hist(log10(thicknesses(mask)),100);